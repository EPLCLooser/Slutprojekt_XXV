module Model
  ...
  #
  # @param user [String] the username for the new user
  # @param pwd [String] the password for the new user
  # @param pwd_confirm [String] the password confirmation
  ...
  # @param place [String] the location of the event
  # @param info [String] additional information about the event
  # @param date [String] the date of the event
  # @param time [String] the time of the event
  # @param event_type_id [Integer] the ID of the event type
  # @return [Boolean] true if the event is added successfully, false otherwise
  ...
  # Allows a user to join an event using a code
  #
  # @param code [Integer] the event code to join
  # @return [Boolean] true if joining is successful, false otherwise
  def join(code)
    db = SQLite3::Database.new("db/databas.db")
    db.results_as_hash = true
  ...
  # Retrieves events owned and joined by the current user, optionally filtered by type
  #
  # @param type_search [Integer, nil] the event type ID to filter by, or nil for all
  # @return [Array<Array<Hash>>] an array containing owned events and joined events
  ...
  # @return [Array<Hash, Integer>] an array containing the event data and ownership status
  ...
  # @param place [String] the new location
  # @param info [String] the new information
  # @param date [String] the new date
  # @param time [String] the new time
  # @param event_type_id [Integer] the new event type ID
  # @param id [Integer] the ID of the event to edit
  # @return [Boolean] true if editing is successful, false otherwise
  ...
  #
  # @param event_id [Integer] the ID of the event to delete
  ...
  #
  # @return [Array<Hash>] an array of user hashes with id, user, and admin status
  ...
  # Deletes a user and all their associated events
  #
